...
//go:generate minimock -i github.com/waryataw/auth/internal/api/auth.UserService -o user_service_minimock.go -n UserServiceMock -p mocks
...
func (mmCreate *mUserServiceMockCreate) Expect(ctx context.Context, user *models.User) *mUserServiceMockCreate {
...
func (mmCreate *mUserServiceMockCreate) ExpectUserParam2(user *models.User) *mUserServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *mUserServiceMockCreate) Inspect(f func(ctx context.Context, user *models.User)) *mUserServiceMockCreate {
...
func (mmCreate *mUserServiceMockCreate) Set(f func(ctx context.Context, user *models.User) (i1 int64, err error)) *UserServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserServiceMockCreate) When(ctx context.Context, user *models.User) *UserServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
...
// Create implements mm_auth.UserService
func (mmCreate *UserServiceMock) Create(ctx context.Context, user *models.User) (i1 int64, err error) {
...
// Delete implements mm_auth.UserService
...
func (mmGet *mUserServiceMockGet) Expect(ctx context.Context, id int64, name string) *mUserServiceMockGet {
	...
	mmGet.defaultExpectation.params = &UserServiceMockGetParams{ctx, id, name}
...
// ExpectNameParam3 sets up expected param name for UserService.Get
func (mmGet *mUserServiceMockGet) ExpectNameParam3(name string) *mUserServiceMockGet {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserServiceMock.Get mock is already set by Set")
	}
...
func (mmGet *mUserServiceMockGet) Inspect(f func(ctx context.Context, id int64, name string)) *mUserServiceMockGet {
...
func (mmGet *mUserServiceMockGet) Set(f func(ctx context.Context, id int64, name string) (up1 *models.User, err error)) *UserServiceMock {
	if mmGet.defaultExpectation != nil {
...
// Then helper
func (mmGet *mUserServiceMockGet) When(ctx context.Context, id int64, name string) *UserServiceMockGetExpectation {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserServiceMock.Get mock is already set by Set")
	}
	...
	expectation := &UserServiceMockGetExpectation{
		mock:               mmGet.mock,
		params:             &UserServiceMockGetParams{ctx, id, name},
...
// Get implements mm_auth.UserService
func (mmGet *UserServiceMock) Get(ctx context.Context, id int64, name string) (up1 *models.User, err error) {
	...
	mm_params := UserServiceMockGetParams{ctx, id, name}
	...
	if mmGet.GetMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockGetParams{ctx, id, name}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.name != nil && !minimock.Equal(*mm_want_ptrs.name, mm_got.name) {
				mmGet.t.Errorf("UserServiceMock.Get got unexpected parameter name, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmGet.t.Fatalf("Unexpected call to UserServiceMock.Get. %v %v %v", ctx, id, name)
	return
}
...
func (mmUpdate *mUserServiceMockUpdate) Expect(ctx context.Context, user *models.User) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) ExpectUserParam2(user *models.User) *mUserServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserServiceMockUpdate) Inspect(f func(ctx context.Context, user *models.User)) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Set(f func(ctx context.Context, user *models.User) (err error)) *UserServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserServiceMockUpdate) When(ctx context.Context, user *models.User) *UserServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
// Update implements mm_auth.UserService
func (mmUpdate *UserServiceMock) Update(ctx context.Context, user *models.User) (err error) {
